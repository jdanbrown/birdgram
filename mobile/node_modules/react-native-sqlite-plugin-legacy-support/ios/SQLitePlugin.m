...
-(id) getDBPath:(NSString *)dbFile at:(NSString *)atkey {
    ...
    // HACK If dbFile is absolute path, return as is (ignoring atkey)
    //  - Workaround documented limitation: "Absolute and relative subdirectory path(s) are not tested or supported"
    //    - https://github.com/xpbrew/react-native-sqlite-plugin-legacy-support#other-limitations
    if ([dbFile hasPrefix:@"/"]) {
      return dbFile;
    }
