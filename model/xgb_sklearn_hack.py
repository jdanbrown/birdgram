"""
xgboost.sklearn "hacks": things I copied and pasted and tweaked from xgboost.sklearn because it was more pragmatic than
(a) working around the desired tweaks or (b) rewriting it entirely myself.

Changes:
- Added train_kwargs to XGBClassifier
"""

# Copyright (c) 2016 by xgboost Contributors
#
...
from xgboost.compat import (
    SKLEARN_INSTALLED, XGBModelBase,
