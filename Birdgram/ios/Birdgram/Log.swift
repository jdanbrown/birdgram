...
public enum Log {
  ...
  public static func error(_ msg: @autoclosure () -> String, _ file: String = #file, _ line: UInt = #line) {
    if __DEV__ { RCTSwiftLog.error ("ERROR \(msg())", file: file, line: line) }
  }

  public static func warn(_ msg: @autoclosure () -> String, _ file: String = #file, _ line: UInt = #line) {
    if __DEV__ { RCTSwiftLog.warn  ("WARN  \(msg())", file: file, line: line) }
  }

  public static func info(_ msg: @autoclosure () -> String, _ file: String = #file, _ line: UInt = #line) {
    if __DEV__ { RCTSwiftLog.info  ("INFO  \(msg())", file: file, line: line) }
  }

  public static func debug(_ msg: @autoclosure () -> String, _ file: String = #file, _ line: UInt = #line) {
    if __DEV__ { RCTSwiftLog.trace ("DEBUG \(msg())", file: file, line: line) }
  }

  // Aliases
  public static func log   (_ msg: @autoclosure () -> String, _ file: String = #file, _ line: UInt = #line) { info(msg, file, line) }
  public static func trace (_ msg: @autoclosure () -> String, _ file: String = #file, _ line: UInt = #line) { debug(msg, file, line) }
